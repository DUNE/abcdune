...
\newduneabbrev{daqdts}{DUNE DTS}{DUNE timing and synchronization subsystem}{The portion of the \gls{daq} that provides for timing and synchronization to various detector systems}
