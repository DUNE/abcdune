...
single-phase detector design}  % #33 11 may 21-  may need an update
...
% 22 Feb 2021
\newduneabbrev{sphd}{FD1-HD}{horizontal drift technology}{LArTPC design in which electrons drift horizontally to wire plane anodes (\glspl{apa}) that along with the front-end electronics are immersed in LAr} % updated 21 May 21

\newduneabbrev{spvd}{FD2-VD}{vertical drift technology}{LArTPC design in which electrons drift vertically to PCB-based anodes at the top and bottom of the LAr volume,  with a cathode in the middle} % updated 21 May 21
...
\newduneword{pd2hd}{ProtoDUNE-II-HD}{The second \gls{protodune} for the \gls{sphd} design, using \gls{np04}, to test installation, integration, and detector component performance}
...
\newduneword{vd}{VD}{vertical drift \gls{tpc} technology} %

\newduneword{hd}{HD}{horizontal drift \gls{tpc} technology} %
...
\newduneword{drb}{DUNE Resources Board}{add def}
