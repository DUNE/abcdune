...
\newduneabbrev{nd}{ND}{near detector}{Refers to the detector(s) %or more  generally the experimental site
 installed close to the neutrino source at \gls{fnal}; in the \gls{lbnf-dune} enterprise it includes integration, installation and the cryogenics systems} %updated 11 may 21
...
\newduneabbrev{utca}{$\mu$TCA}{Micro Telecommunications Computing Architecture}{The computer architecture specification followed by the crates that house charge and light readout electronics in the \gls{dpmod}} %11 may 2021 (still needed?)
...
\newduneabbrev{nscfb}{NSCF+B}{Near Site Conventional Facilities and Beamline}{All 
  ...
  \newduneabbrev{fd1c}{FD1+C}{far detector module 1 + cryogenics}{The first far detector module to be built at \gls{surf}, including integration and installation, and all cryogenics infrastructure to support FD1 and \gls{fd2}} %new 11 may 21
  \newduneabbrev{fd2}{FD2}{far detector module 2}{The second far detector module to be built at \gls{surf}} %new 11 may 21
...
\newduneabbrev{lbnf}{LBNF}{Long-Baseline Neutrino Facility}{Long-Baseline Neutrino Facility; refers to the facilities that support the experiment including in-kind contributions under the line-item project. LBNF is responsible for developing the neutrino beam, the far site cryostats  and far and near site cryogenics systems, and the conventional facilities for  \gls{dune} } % #36, updated 11 may 2021
  
\newduneabbrev{lbnf-dune}{LBNF/DUNE}{LBNF and DUNE enterprise}{Long-Baseline Neutrino Facility/Deep Underground Neutrino Experiment; refers to the enterprise or program including \gls{usproj} and  \gls{dune} } %updated 11 may 2021 (#35 09nov20)
...
\newduneabbrev{crp}{CRP}{charge-readout plane}{An anode technology using perforated \dword{pcb}-based \dword{cro} with projecting electrodes immersed in \dword{lar}}
...
\newduneabbrev{sftchimney}{SFT chimney}{signal feedthrough chimney}{In the \gls{dp} technology, a volume above the cryostat penetration used for a signal feedthrough} %11 may 2021 - still used in Vert Drift? ask Jae
...
\newduneword{greyrm}{grey room}{ISO-8 clean room with a cleanliness level of 3.5M particles of 0.5 micron or less per cubic meter volume. ISO-8 clean rooms are referred to as gray rooms because at this level of cleanliness most standard clean room attire is not required.}
...
\newduneword{fsm}{Finite State Machine}{a mathematical model of computation; t is an abstract machine that can be in exactly one of a finite number of states at any given time} % in DAQ
