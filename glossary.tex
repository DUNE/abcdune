...
portion of a \gls{detmodule} may be further partitioned into a number of similar parts.   For example, the \gls{sp} \gls{tpc} is made up of \gls{apa}  units (and other elements)}
