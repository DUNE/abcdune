...
single-phase detector design}  % #33 11 may 21-  may need an update % 12/21/2022 Dont use!!
...
% 22 Feb 2021
\newduneabbrev{sphd}{FD1-HD}{horizontal drift detector module}{LArTPC design in which electrons drift horizontally to wire plane anodes (\glspl{apa}) that along with the front-end electronics are immersed in LAr} % updated 21 May 21

\newduneabbrev{spvd}{FD2-VD}{vertical drift detector module}{LArTPC design in which electrons drift vertically to PCB-based anodes at the top and bottom of the LAr volume,  with a cathode in the middle} % updated 21 May 21
...
\newduneword{pd2hd}{ProtoDUNE-II-HD}{The second ProtoDUNE for the horizontal drift design, using NP04, to test installation, integration, and detector component performance}

%\newduneword{pd2vd}{ProtoDUNE-II-VD}{The ProtoDUNE for the \gls{spvd} design, using \gls{np02}, to test installation, integration, and detector component performance}
...
\newduneword{pd2}{ProtoDUNE-II}{\gls{protodune} test runs at CERN in 2022-2023; includes \gls{pdhd} and \gls{pdvd}}
...
\newduneabbrev{hdf5}{HDF5}{Hierarchical Data Format}{Data format\cite{bib:hdf5} widely used in \gls{ml}} 
...
\newduneword{garfield}{Garfield}{A simulation program\cite{Veenhof:1998tt} developed at \gls{cern} for gaseous detectors } 
...
\newduneword{jobsub}{JobSub}{\cite{box2014fife} the \gls{fnal} \gls{if} job submission client that supports user submission of complex workflows to HT-Condor} 
...
\newduneabbrev{coffea}{COFFEA}{Columnar Object Framework For Effective Analysis}{Columnar data analysis frame\-work\cite{Smith:2020pxs} developed at \gls{fnal}} 
