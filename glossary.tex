...
The CERN North Area in \gls{ehn1} intersected by the \gls{h4} hadron beamline,  the location of  \gls{pdsp}; also used to refer to the 800\,t cryostat in this area}
...
\newduneword{h4}{H4}{CERN North Area hadron beamline used for \gls{pdsp}}  % #33
...
\newduneword{pd2hd}{ProtoDUNE-II-HD}{The second ProtoDUNE for the HD design, using NP04 to test installation, integration, and detector component performance}
