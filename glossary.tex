...
% 22 Feb 2021
\newduneabbrev{sphd}{HDrift}{horizontal drift}{LArTPC design in which electrons drift horizontally to wire plane anodes (\glspl{apa}) that along with the front-end electronics are immersed in LAr}

\newduneabbrev{spvd}{VDrift}{vertical drift}{LArTPC design in which electrons drift vertically to PCB-based anodes at the top and bottom of the LAr volume, with a cathode in the middle} % updated 11 May 21; may need further update
