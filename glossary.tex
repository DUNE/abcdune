...
\newduneword{mod0}{Module 0}{The final pre-production instance of a detector; for the DUNE \glspl{detmodule}, these will use the 800\,t cryostats in \gls{np02} and \gls{np04}}
