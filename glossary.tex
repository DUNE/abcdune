...
\newduneabbrev{ifdh}{ifdh}{Intensity Frontier Data Handling}{The actual command invoked when using \gls{ifdhc}, on the command line, e.g. ifdh cp source$_$file dest$_$file}
